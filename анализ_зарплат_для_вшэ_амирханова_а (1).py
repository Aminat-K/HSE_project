...
- all_r - реальная заработная плата в среднем по всем видам экономической деятельности в целом (РЗП по всем отраслям), тыс. руб.
"""
...
plt.ylabel('Номинальная и реальная зароботная плата по всем отраслям', fontsize = 8) #подпись оси ординат
...
plt.ylabel('Номинальная и реальная зароботная плата в области здравоохранения', fontsize = 8) #подпись оси ординат
plt.xlabel("Год", fontsize = 8) #подпись оси абцисс
ax = sns.barplot(data = df,
            x = 'year',
            y = 'health_r');
...
plt.ylabel('Номинальная и реальная зароботная плата в области образования', fontsize = 8) #подпись оси ординат
plt.xlabel("Год", fontsize = 8) #подпись оси абцисс
ax = sns.barplot(data = df,
            x = 'year',
            y = 'education_r');
...
plt.ylabel('Номинальная и реальная зароботная плата в области добычи полезных ископаемых', fontsize = 8) #подпись оси ординат
plt.xlabel("Год", fontsize = 8) #подпись оси абцисс
ax = sns.barplot(data = df,
            x = 'year',
            y = 'mining_r');
